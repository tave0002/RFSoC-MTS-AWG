...
module memory_standin_downstream#( parameter DATA_WIDTH = 512, parameter ADDR_WIDTH = 40)(
        ...
        if(burstCount== 8'b00000000) begin
          ...
          if(setupFlag == 1) begin
            ...
            if(rvalid == 0) begin
              ...
              dataBus[263:256]<=8'b10000000+burstCount; //done so I can confirm the dwidth conversion is working correctly
