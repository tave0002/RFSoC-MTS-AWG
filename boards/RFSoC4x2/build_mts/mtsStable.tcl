...
#
# mtsStable.tcl: Tcl script for re-creating project 'mts'
#
# Generated by Vivado on Wed Feb 19 11:50:09 +1100 2025
...
#
# 1. This project restoration tcl script (mtsStable.tcl) that was generated.
#
...
#
#    "F:/RFSoC-MTS-main-V21/boards/ip/rtl/DACRAMstreamer.v"
#    "F:/RFSoC-MTS-main-V21/boards/ip/rtl/ADCRAMcapture.v"
#    "F:/RFSoC-MTS-main-V21/boards/RFSoC4x2/build_mts/mts.xdc"
...
set orig_proj_dir "F:/RFSoC-MTS-main-V21/boards/RFSoC4x2/build_mts/mts"
...
set_property -name "ip_output_repo" -value "F:/RFSoC-MTS-main-V21/boards/RFSoC4x2/build_${_xil_proj_name_}/${_xil_proj_name_}/${_xil_proj_name_}.cache/ip" -objects $obj
...
set_property -name "sim.central_dir" -value "F:/RFSoC-MTS-main-V21/boards/RFSoC4x2/build_${_xil_proj_name_}/${_xil_proj_name_}/${_xil_proj_name_}.ip_user_files" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "F:/RFSoC-MTS-main-V21/ip" $obj
...
set file "F:/RFSoC-MTS-main-V21/boards/ip/rtl/DACRAMstreamer.v"
...
set file "F:/RFSoC-MTS-main-V21/boards/ip/rtl/ADCRAMcapture.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "F:/RFSoC-MTS-main-V21/boards/RFSoC4x2/build_mts/mts.xdc"
...
if { [get_files DACRAMstreamer.v] == "" } {
  import_files -quiet -fileset sources_1 F:/RFSoC-MTS-main-V21/boards/ip/rtl/DACRAMstreamer.v
}
if { [get_files DACRAMstreamer.v] == "" } {
  import_files -quiet -fileset sources_1 F:/RFSoC-MTS-main-V21/boards/ip/rtl/DACRAMstreamer.v
}
...
# Hierarchical cell: hier_dac_play1
proc create_hier_cell_hier_dac_play1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_dac_play1() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_clocktreeMTS { parentCell nameHier } {
  ...
  # Create instance: hier_dac_play1
  create_hier_cell_hier_dac_play1 [current_bd_instance .] hier_dac_play1
...
connect_bd_intf_net -intf_net [get_bd_intf_nets deepCapture_M_AXI_S2MM] [get_bd_intf_pins deepCapture/M_AXI_S2MM] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net hier_dac_play1_M_AXIS_0 [get_bd_intf_pins hier_dac_play1/M_AXIS_0] [get_bd_intf_pins usp_rf_data_converter_1/s00_axis]
  ...
  connect_bd_intf_net -intf_net internalRAM_interconnect_M04_AXI [get_bd_intf_pins hier_dac_play1/S_AXI] [get_bd_intf_pins internalRAM_interconnect/M04_AXI]
  ...
  connect_bd_net -net axi_gpio_dac_gpio_io_o [get_bd_pins gpio_control/dac_enable] [get_bd_pins hier_dac_play/enable] [get_bd_pins hier_dac_play1/enable]
  connect_bd_net -net axi_gpio_fifo_flush_gpio_io_o [get_bd_pins deepCapture/fifo_flush_n] [get_bd_pins gpio_control/fifoflush]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clocktreeMTS/clkRF] [get_bd_pins deepCapture/s_axis_aclk] [get_bd_pins hier_dac_play/aclk] [get_bd_pins hier_dac_play1/aclk] [get_bd_pins usp_rf_data_converter_1/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_1/s1_axis_aclk] [get_bd_pins usp_rf_data_converter_1/s2_axis_aclk]
  connect_bd_net -net clk_wiz_adc0_clk_out2 [get_bd_pins clocktreeMTS/clkRFdiv2] [get_bd_pins gpio_control/dest_clk] [get_bd_pins hier_dac_play/axis_clk] [get_bd_pins hier_dac_play1/axis_clk] [get_bd_pins internalRAM_interconnect/ACLK] [get_bd_pins internalRAM_interconnect/M00_ACLK] [get_bd_pins internalRAM_interconnect/M01_ACLK] [get_bd_pins internalRAM_interconnect/M02_ACLK] [get_bd_pins internalRAM_interconnect/M03_ACLK] [get_bd_pins internalRAM_interconnect/M04_ACLK] [get_bd_pins internalRAM_interconnect/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  ...
  assign_bd_address -offset 0x000501000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_dac_play1/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x000500000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_dac_play/axi_bram_ctrl_0/S_AXI/Mem0] -force
...
if { [get_property IS_LOCKED [ get_files -norecurse mts.bd] ] == 1  } {
  import_files -fileset sources_1 "F:/RFSoC-MTS-main-V21/boards/RFSoC4x2/build_mts/mts/mts.gen/sources_1/bd/mts/hdl/mts_wrapper.vhd"
} else {
